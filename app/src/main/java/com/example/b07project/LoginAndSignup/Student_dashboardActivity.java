...
public class Student_dashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //click scheduled events
        findViewById(R.id.scheduled_events).setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                //go to submit fragment
                Intent intent = new Intent(Student_dashboardActivity.this, Feedback_StudentActivity.class);
                startActivity(intent);
            }
        });
