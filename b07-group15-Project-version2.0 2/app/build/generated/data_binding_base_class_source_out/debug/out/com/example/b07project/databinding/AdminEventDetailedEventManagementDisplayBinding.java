...
public final class AdminEventDetailedEventManagementDisplayBinding implements ViewBinding {
  @NonNull
  ...
  private AdminEventDetailedEventManagementDisplayBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static AdminEventDetailedEventManagementDisplayBinding inflate(
  ...
  public static AdminEventDetailedEventManagementDisplayBinding inflate(
    ...
    View root = inflater.inflate(R.layout.admin_event_detailed_event_management_display, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdminEventDetailedEventManagementDisplayBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdminEventDetailedEventManagementDisplayBinding((ConstraintLayout) rootView,
          backBar, descriptionTextView, endTimeTextView, feedback, locationTextView, spaceTextView,
