...
public final class AdminStaterLoginBinding implements ViewBinding {
  @NonNull
  ...
  private AdminStaterLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Toolbar backBar,
  ...
  @NonNull
  public static AdminStaterLoginBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdminStaterLoginBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.admin_stater_login, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdminStaterLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdminStaterLoginBinding((ConstraintLayout) rootView, backBar, linearLayoutCompat,
          linearLayoutCompat2, passwordEditText, signInButton, signUpButton, textView2,
          usernameEditText);
    }
