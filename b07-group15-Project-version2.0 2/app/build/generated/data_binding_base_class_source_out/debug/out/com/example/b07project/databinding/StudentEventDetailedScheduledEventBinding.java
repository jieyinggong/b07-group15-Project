...
public final class StudentEventDetailedScheduledEventBinding implements ViewBinding {
  @NonNull
  ...
  private StudentEventDetailedScheduledEventBinding(@NonNull ConstraintLayout rootView,
      @NonNull Toolbar backBar, @NonNull TextView descriptionTextView,
      @NonNull TextView endTimeTextView, @NonNull TextView feedback,
      @NonNull TextView locationTextView, @NonNull TextView spaceTextView,
      @NonNull TextView startTimeTextView, @NonNull TextView subjectTextView,
  ...
  @NonNull
  public static StudentEventDetailedScheduledEventBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static StudentEventDetailedScheduledEventBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.student_event_detailed_scheduled_event, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static StudentEventDetailedScheduledEventBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new StudentEventDetailedScheduledEventBinding((ConstraintLayout) rootView, backBar,
          descriptionTextView, endTimeTextView, feedback, locationTextView, spaceTextView,
