...
public final class StudentEventDetailedUpcomingEventBinding implements ViewBinding {
  @NonNull
  ...
  private StudentEventDetailedUpcomingEventBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView RSVP, @NonNull Toolbar backBar, @NonNull TextView descriptionTextView,
  ...
  @NonNull
  public static StudentEventDetailedUpcomingEventBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static StudentEventDetailedUpcomingEventBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.student_event_detailed_upcoming_event, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static StudentEventDetailedUpcomingEventBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.RSVP;
      TextView RSVP = ViewBindings.findChildViewById(rootView, id);
      if (RSVP == null) {
        break missingId;
      }
      ...
      return new StudentEventDetailedUpcomingEventBinding((ConstraintLayout) rootView, RSVP,
          backBar, descriptionTextView, endTimeTextView, locationTextView, spaceTextView,
