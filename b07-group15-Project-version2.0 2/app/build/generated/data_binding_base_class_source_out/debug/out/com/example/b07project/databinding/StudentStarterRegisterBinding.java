...
public final class StudentStarterRegisterBinding implements ViewBinding {
  @NonNull
  ...
  private StudentStarterRegisterBinding(@NonNull ConstraintLayout rootView,
      @NonNull Toolbar backBar, @NonNull EditText fullNameEditText,
  ...
  @NonNull
  public static StudentStarterRegisterBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static StudentStarterRegisterBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.student_starter_register, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static StudentStarterRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new StudentStarterRegisterBinding((ConstraintLayout) rootView, backBar,
          fullNameEditText, linearLayoutCompat, linearLayoutCompat2, linearLayoutCompat3,
          passwordEditText, signUpButton, textView2, usernameEditText);
    }
